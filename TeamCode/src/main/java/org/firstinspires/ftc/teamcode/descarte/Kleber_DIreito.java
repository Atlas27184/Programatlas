...
@Autonomous(name = "Autônomo Direito") //Definição do nome que vai aparecer no Driver Hub
public class Kleber_DIreito extends LinearOpMode {
    ...
    private static final double KpTurn = 0.0109;
    ...
    public void drive(double power, double distanceMM, double targetAngle) {
